...
groups <- factor(c(rep("control", 50), rep("induced", 50)))
...
ggplot(data=loadings.plot, aes(x=wavenumber)) + geom_line(aes(y=PC1, col="PC1")) + geom_line(aes(y=PC3, col="PC3")) + coord_cartesian(expand=FALSE) + scale_x_reverse() + geom_hline(yintercept=0)
